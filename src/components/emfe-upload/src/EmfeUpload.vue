<template>
  <div class="emfe-upload" :class="uploadName">
    <template v-if="type === 'icon'">
      ...
      <input class="emfe-upload-file" :class="fileName" :disabled="disabled || !canUpload" type="file" @change="change" ref="upload">
    ...
    <template v-if="type === 'plus'">
      ...
      <input class="emfe-upload-file" :class="fileName" :disabled="disabled || !canUpload" type="file" @change="change" ref="uploadPlus">
