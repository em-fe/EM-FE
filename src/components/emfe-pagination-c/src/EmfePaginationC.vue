<template>
   <div class="emfe-pagination-c">
    <ul>
      ...
      <li class="emfe-pagination-c-item" v-show="curPageOn > 5 && pageCount > 6  && bigLimit != 4" >...</li>
      ...
      <li class="emfe-pagination-c-item" v-show="curPageOn <= bigLimit && pageCount > 6  && bigLimit != 4">...</li>
