...
var emfeIscroll = {
  inserted: function inserted(el, binding, vnode) {
    var callBack;
    var iscrollOptions = binding.value;
    // 判断输入参数
    var vtype = binding.value ? O.type(binding.value) : undefined;
    switch (vtype) {
      case '[object Array]':
