...
var prefixCls$10 = 'emfe-datapanel';
var EmfeDatapanel$1 = {
...
staticRenderFns: [],
  ...
  computed: {
    classList: function classList() {
      return [
        ( obj = {}, obj[(prefixCls$11 + "-" + (this.className) + "-disable")] = this.disable, obj[(prefixCls$11 + "-" + (this.className))] = !this.disable, obj[(prefixCls$11 + "-" + (this.className) + "-active")] = this.activeOk && !this.skin, obj[(prefixCls$11 + "-" + (this.className) + "-" + (this.skin))] = !!this.skin, obj[(prefixCls$11 + "-" + (this.className) + "-" + (this.skin) + "-active")] = this.activeOk && !!this.skin, obj[((this.addName) + "-tag")] = !!this.addName, obj ) ];
      var obj;
    },
  },
  methods: {
