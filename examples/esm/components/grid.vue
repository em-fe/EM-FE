<template>
  <div class="grid">
    <h2>emui 栅格系统</h2>
    <h3>概述 - 24栅格系统</h3>
    <Row :gutter="12" :basin="12" type="flex" v-for="(text, m) in texts" :key="m" justify="center" align="middle" class-name="row-grid">
      <Col :span="24 / text.length" v-for="(t, n) in text" :key="n">
        <div class="blue">{{t}}</div>
      </Col>
    </Row>
    <p>在多数业务情况下，emui 需要在设计区域内解决大量信息收纳的问题，因此在 12 栅格系统的基础上，我们将整个设计建议区域按照 24 等分的原则进行划分。</p>
    <p>划分之后的信息区块我们称之为『盒子』。建议横向排列的盒子数量最多四个，最少一个。『盒子』在整个屏幕上占比见上图。设计部分基于盒子的单位定制盒子内部的排版规则，以保证视觉层面的舒适感。</p>
    <ul>
      <li>使用 row 在水平方向创建一行</li>
      <li>将一组 col 插入在 row 中</li>
      <li>在每个 col 中，键入自己的内容</li>
      <li>通过设置 col 的 span 参数，指定跨越的范围，其范围是 1 到 24</li>
      <li>每个 row 中的 col 总和应该为 24</li>
    </ul>
    <h3>代码示例</h3>
    1. 基本用法
    <Row type="flex">
      <Col :span="12">
        <Row className="row-gray">
          <Col span="12">
            <div>col-12</div>
          </Col>
          <Col span="12">
...
&lt;/Row&gt;
    ...
    <Row type="flex">
      <Col :span="12">
        <Row :gutter="16" className="row-gray">
          <Col span="6">
    ...
    <Row type="flex">
      <Col :span="12">
        <Row className="row-gray">
          ...
          <Col span="6" push="18">
            <div class="yellow">col-6 | push-18</div>
          </Col>
        </Row>
      </Col>
      <Col :span="12">
    ...
    <Row type="flex">
      <Col :span="12">
        <Row className="row-gray">
          ...
          <Col span="8" offset="8">
            <div class="yellow">col-8 | offset-8</div>
          </Col>
        </Row>
        <br>
        <Row className="row-gray">
          ...
          <Col span="6" offset="4">
            <div class="yellow">col-6 | offset-4</div>
          </Col>
        </Row>
      </Col>
      <Col :span="12">
...
&lt;/Row&gt;
    ...
    <Row type="flex">
      <Col :span="12">
        <Row className="row-gray" type="flex" justify="start" align="top">
          <Col span="4">
...
&lt;/Row&gt;
    ...
    <Row type="flex">
      <Col :span="12">
        <Row className="row-grid" type="flex" justify="center" align="top">
          <Col span="4">
            <p class="yellow" style="height: 80px">col-4</p>
          </Col>
          <Col span="4">
            <p class="yellow" style="height: 30px">col-4</p>
          </Col>
          <Col span="4">
            <p class="yellow" style="height: 100px">col-4</p>
          </Col>
          <Col span="4">
            <p class="yellow" style="height: 60px">col-4</p>
          </Col>
        </Row>
      </Col>
      <Col :span="12">
...
&lt;/Row&gt;
    ...
    <Row type="flex">
      <Col :span="12">
        <Row className="row-grid" type="flex" justify="center" align="bottom">
          <Col span="4">
            <p class="yellow" style="height: 80px">col-4</p>
          </Col>
          <Col span="4">
...
&lt;/Row&gt;
    ...
    <Row type="flex">
      <Col :span="12">
        <Row className="row-grid" type="flex" justify="center" align="middle">
          <Col span="4">
            <p class="yellow" style="height: 80px">col-4</p>
          </Col>
          <Col span="4">
...
&lt;/Row&gt;
    ...
    <table>
      ...
      <tbody>
        <tr>
          <td>gutter</td>
          <td>栅格间距，单位 px ，左右平分。范围： 0 ~ 48 。</td>
          <td>Number | String</td>
          <td><a href="http://www.uisdc.com/8-point-grid-system">8</a></td>
        </tr>
        <tr>
          <td>basin</td>
          <td>垂直栅格间距，单位 px ，上下平分。范围： 0 ~ 48 。</td>
          <td>Number | String</td>
          <td>0</td>
        </tr>
        <tr>
          <td>type</td>
          <td>布局模式，可选值为 flex 或不选。 flex 在现代浏览器下有效。</td>
          <td>String</td>
          <td>-</td>
        </tr>
        <tr>
          <td>align</td>
          <td>flex 布局下的垂直对齐方式，可选值为 top 、 middle 、 bottom 。</td>
          <td>String</td>
          <td>-</td>
        </tr>
        <tr>
        <td>justify</td>
          <td>flex 布局下的水平排列方式，可选值为 start 、 end、center 、 space-around、  space-between 。</td>
          <td>String</td>
          <td>-</td>
        </tr>
    ...
    <table>
      ...
      <tbody>
        <tr>
          <td>span</td>
          <td>栅格的占位格数，可选值为 0 ~ 24 的整数，为 0 时，相当于 display: none。</td>
          <td>Number | String</td>
          <td>-</td>
        </tr>
        <tr>
